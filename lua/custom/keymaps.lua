...
-- Sessions
key_set('n', '<leader>qs', ':mksession!<CR>', {desc= 'Make session'})
key_set('n', '<leader>ql', ':source Session.vim<CR>', {desc= 'Load session'})
...
key_set('t', '<Esc><Esc>', '<C-\\><C-n>', {desc= 'Exit terminal mode'})
