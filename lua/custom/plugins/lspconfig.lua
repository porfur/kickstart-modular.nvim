    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function lsp_rename_in_command_window()
            return vim.cmd 'LspRenameInCommandWindow'
          end

          -- Rename the variable under your cursor.
          --  Most Language Servers support renaming across files, etc.
          map('<leader>cr', lsp_rename_in_command_window, '[r]ename')
          ...
          map('<leader>cS', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace [S}ymbols')
